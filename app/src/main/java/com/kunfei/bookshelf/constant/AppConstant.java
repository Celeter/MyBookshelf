...
public class AppConstant {
    ...
    public static String BOOK_EXPORT_PATH = MApplication.downloadPath + File.separator + "book_export" + File.separator;
    ...
    public static final String DEFAULT_USER_AGENT = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.6868.105 Safari/537.36 Edg/86.0.522.59";
